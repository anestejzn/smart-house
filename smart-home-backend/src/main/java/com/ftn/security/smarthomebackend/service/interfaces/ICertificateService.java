...
public interface ICertificateService {
    void createAndSaveRootCertificate() throws KeyStoreMalfunctionedException, InvalidKeyUsagesComboException, InvalidCertificateException, CertificateParsingException;
    void createAndSaveIntermediateCertificate(final String alias) throws KeyStoreMalfunctionedException, AliasDoesNotExistException, InvalidKeyUsagesComboException, InvalidCertificateException, CertificateParsingException;
    ...
    List<SortedAliasesResponse> getAliasesByFilters(final CertificateSortType type, final CertificateValidityType validity) throws KeyStoreCertificateException, EntityNotFoundException, CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, NoSuchProviderException, InvalidCertificateException, KeyStoreMalfunctionedException;
    List<CertificateResponse> getCertificateByAlias(final String alias) throws KeyStoreCertificateException, EntityNotFoundException, CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, NoSuchProviderException, InvalidCertificateException, KeyStoreMalfunctionedException;
    boolean cancelCertificate(final String alias, final String reason) throws EntityNotFoundException, AliasAlreadyExistsException, AliasDoesNotExistException, KeyStoreMalfunctionedException;
}
