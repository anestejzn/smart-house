...
public class DeviceService implements IDeviceService {
    ...
    @Override
    public DeviceResponse createDevice(DeviceType deviceType, String name, String filterRegex, int periodRead, Long realEstateId) throws CannotPerformActionException, EntityNotFoundException {
