...
public interface IDeviceService {
    ...
    DeviceResponse createDevice(DeviceType deviceType, String name, String filterRegex, int periodRead, Long realEstateId) throws CannotPerformActionException, EntityNotFoundException;
}
